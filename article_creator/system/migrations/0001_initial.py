    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doing_news_generation_for_yesterday', models.BooleanField(default=False)),
                ('doing_news_generation_for_yesterday_similarity', models.BooleanField(default=False)),
                ('doing_news_information_graph', models.BooleanField(default=False)),
                ('doing_news_information_sub_graph', models.BooleanField(default=False)),
                ...
                ('last_news_generation_for_yesterday_similarity_begin', models.DateTimeField(null=True)),
                ('last_news_generation_for_yesterday_similarity_end', models.DateTimeField(null=True)),
                ...
                ('last_articles_stats', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='system.articlesstatistics')),
